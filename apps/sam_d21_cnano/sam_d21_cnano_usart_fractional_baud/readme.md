...
title: USART with Fractional Baud rate configuration on SAM D21 Curiosity Nano Evaluation Kit
nav_order: 1
---
<img src = "images/microchip_logo.png">
<img src = "images/microchip_mplab_harmony_logo_small.png">

# USART with Fractional Baud rate configuration on SAM D21 Curiosity Nano Evaluation Kit
<h2 align="center"> <a href="https://github.com/Microchip-MPLAB-Harmony/reference_apps/releases/latest/download/sam_d21_cnano_usart_fractional_baud.zip" > Download </a> </h2>

-----
## Description

>  This application demonstrates the basic functionality of USART communication between two SAM D21 Curiosity Nano Evaluation Kits with the fractional baud rate of 11000. The host and client can send/receive data with the help of serial consoles.
...
- Open the project (sam_d21_cnano_usart_fractional_baud\firmware\sam_d21_cnano.X) in MPLAB X IDE
